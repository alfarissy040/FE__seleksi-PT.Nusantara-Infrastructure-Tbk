...
const TableItems = ({ id, title, author, published, publisher, pages }) => {
    const handleDelete = () => {};
    return (
        <tr className="bg-white border-b  hover:bg-gray-50">
            ...
            <td className="px-6 py-4 text-right flex items-center gap-2">
                ...
                {/* delete */}
                <HiTrash className="w-5 h-5 text-gray-900 hover:text-rose-600 cursor-pointer" onClick={handleDelete} />
            </td>
        </tr>
    );
};
